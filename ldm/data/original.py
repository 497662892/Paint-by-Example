...
class OpenImageDataset(data.Dataset):
    def __init__(self,state,arbitrary_mask_percent=0,**args
        ...
        self.bbox_path_list=[]
        if state == "train":
            bbox_dir = os.path.join(args['dataset_dir'], 'train', 'bboxs')
    ...
    def __getitem__(self, index):
        ...
        return {"GT":image_tensor_resize,"inpaint_image":inpaint_tensor_resize,"inpaint_mask":mask_tensor_resize,"ref_imgs":ref_image_tensor,"real_mask":real_mask_tensor_resize}
